  ...
  useEffect(() => {
    const fetchTrendingMovieData = async () => {
      try {
        ...
        console.log("Une erreur est intervenue lors de la récupération des données concernant les films tendance", error);
      } finally {
        SetLoading(false);
      }
    };
    ...
    <div>
      {Loading ? (
        ...
        <div className="w-full">
          <p className="text-center text-lg mb-4">Faites glisser pour voir plus</p>
          <Swiper
            navigation
